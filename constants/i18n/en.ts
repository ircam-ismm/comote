...
export default {
  ...
  settings: {
    header: 'Settings',
    outputApiChange: 'Please note that the version 3 of CoMote uses a different format than the version 2. Please refer to the documentation.',
    outputApiAvailable: 'See below for a temporary compatibility mode.',
